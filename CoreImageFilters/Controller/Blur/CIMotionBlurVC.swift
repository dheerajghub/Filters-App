...
class CIMotionBlurVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.radiusLabel.text = "Input Radius: \(Int(radiusSlider.value))"
        self.angleLabel.text = "Input Angle: \(Int(angleSlider.value))"
    ...
    func setUpConstraints(){
        NSLayoutConstraint.activate([
            ...
            angleSlider.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 30),
            angleSlider.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -30),
            angleSlider.bottomAnchor.constraint(equalTo: radiusLabel.topAnchor, constant: -20),
            
            angleLabel.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            angleLabel.bottomAnchor.constraint(equalTo: angleSlider.topAnchor, constant: -8)
        ])
    }
    
    func processing(){
        let filter = CIFilter.addMotionBlur(inputImage: beginImage!, inputRadius: NSNumber(value:radiusSlider.value), inputAngle: NSNumber(value: angleSlider.value))
