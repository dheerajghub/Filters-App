...
class CIGaussianBlurVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate {
    ...
    func processing(){
        let filter = CIFilter.addGaussianBlur(inputImage: beginImage!, inputRadius: NSNumber(value:radiusSlider.value))
