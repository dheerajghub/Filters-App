...
//  CoreImageFilters
//
//  Created by Dheeraj Kumar Sharma on 10/11/20.
//  Copyright © 2020 Dheeraj Kumar Sharma. All rights reserved.
//

import UIKit

class CIBoxBlurVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate {
    ...
    func processing(){
        let filter = CIFilter.addBoxBlur(inputImage: beginImage!, inputRadius: NSNumber(value: radiusSlider.value))
