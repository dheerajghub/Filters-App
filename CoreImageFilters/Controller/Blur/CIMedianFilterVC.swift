...
class CIMedianFilterVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func processing(){
        let filter = CIFilter.addMedianFilter(inputImage: beginImage!)
