...
class CIVibranceVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        amountLabel.text = "Amount Value: \(Double(amountSlider.value).uptoDecimal)"
    ...
    func setUpConstraints(){
        NSLayoutConstraint.activate([
            ...
            amountSlider.bottomAnchor.constraint(equalTo: pickImage.topAnchor, constant: -20),
            amountSlider.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 30),
            amountSlider.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -30),
            
            amountLabel.bottomAnchor.constraint(equalTo: amountSlider.topAnchor, constant: -20),
    ...
    func processing(){
        let filter = CIFilter.addVibrance(inputImage: beginImage!, inputAmount: NSNumber(value:amountSlider.value))
    ...
    @objc func changeInPower(_ :UISlider){
        amountLabel.text = "Angle Value: \(Double(amountSlider.value).uptoDecimal)"
        processing()
    }
