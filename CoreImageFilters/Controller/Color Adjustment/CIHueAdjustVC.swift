...
class CIHueAdjustVC: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        angleSlider.value = 0.0
        angleLabel.text = "Angle Value: \(Double(angleSlider.value).uptoDecimal)"
    ...
    func setUpConstraints(){
        NSLayoutConstraint.activate([
            ...
            angleSlider.bottomAnchor.constraint(equalTo: pickImage.topAnchor, constant: -20),
            ...
            angleLabel.bottomAnchor.constraint(equalTo: angleSlider.topAnchor, constant: -20),
    ...
    func processing(){
        let filter = CIFilter.addHueAdjust(inputImage: beginImage!, inputAngle: NSNumber(value:angleSlider.value))
