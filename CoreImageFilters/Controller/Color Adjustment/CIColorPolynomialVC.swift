...
class CIColorPolynomialVC: UIViewController , UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func processing(){
        let filter = CIFilter.addColorPolynomial(inputImage: beginImage!)
